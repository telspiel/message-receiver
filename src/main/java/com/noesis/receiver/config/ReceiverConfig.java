package com.noesis.receiver.config;
...
import com.noesis.receiver.MessageReceiver;
...
public class ReceiverConfig {
  ...
  @Value("${kafka.number.of.partitions.for.topic}")
  ...
  public Map<String, Object> consumerConfigs() {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, "consumer-trans-group");
  ...
  public MessageReceiver receiver() {
    return new MessageReceiver(Integer.parseInt(maxPollRecordsSize));
  }
